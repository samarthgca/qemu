...
static void flag(int inst, TCGv_i32 dest, TCGv_i32 s1, TCGv_i32 s2)
{
    if (inst == 0b001010) {
        tcg_gen_setcondi_i32(TCG_COND_EQ, cpu_zf, dest, 0);
        tcg_gen_shri_i32(cpu_nf, dest, 31);
    } else if (inst == 0b000000) {
        tcg_gen_setcondi_i32(TCG_COND_EQ, cpu_zf, dest, 0);
        tcg_gen_shri_i32(cpu_nf, dest, 31);
        tcg_gen_setcond_i32(TCG_COND_LTU, cpu_cf, dest, s1);
        TCGv_i32 vflag = cpu_vflag_add(s1, dest, s2);
        tcg_gen_mov_i32(cpu_vf, vflag);
    } else if (inst == 0b011010) {
        tcg_gen_setcondi_i32(TCG_COND_EQ, cpu_zf, s1, 0);
        tcg_gen_shri_i32(cpu_nf, s2, 31);
        TCGv_i32 sign_ext = tcg_temp_new_i32();
        tcg_gen_sari_i32(sign_ext, s1, 31);
        tcg_gen_setcond_i32(TCG_COND_NE, cpu_vf, s2, sign_ext);
    } else if (inst == 0b000010) {
        tcg_gen_setcondi_i32(TCG_COND_EQ, cpu_zf, dest, 0);
        tcg_gen_shri_i32(cpu_nf, dest, 31);
        tcg_gen_setcond_i32(TCG_COND_LTU, cpu_cf, s1, s2);
        TCGv_i32 vflag = cpu_vflag_sub(s1, dest, s2);
        tcg_gen_mov_i32(cpu_vf, vflag);
    } else if (inst == 0b110000) {
        tcg_gen_setcondi_i32(TCG_COND_EQ, cpu_zf, s1, 0);
        tcg_gen_shri_i32(cpu_nf, s1, 31);
        tcg_gen_setcond_i32(TCG_COND_LTU, cpu_cf, s1, s2);
        TCGv_i32 t0 = tcg_temp_new_i32();
        tcg_gen_xor_i32(t0, s2, s1);
        tcg_gen_shri_i32(cpu_vf, t0, 31);
    } else if (inst == 0b100000) {
        tcg_gen_setcondi_i32(TCG_COND_EQ, cpu_zf, s1, 0);
        tcg_gen_shri_i32(cpu_nf, s1, 31);
        tcg_gen_shri_i32(cpu_cf, s2, 31);
    } else if (inst == 0b111000) {
        tcg_gen_setcondi_i32(TCG_COND_EQ, cpu_zf, s1, 0);
        tcg_gen_shri_i32(cpu_nf, s1, 31);
        tcg_gen_andi_i32(cpu_cf, s2, 1);
    } else if (inst == 0b100001) {
        tcg_gen_setcondi_i32(TCG_COND_EQ, cpu_zf, s1, 0);
        tcg_gen_shri_i32(cpu_nf, s1, 31);
        tcg_gen_andi_i32(cpu_cf, s2, 1);
    }
...
{   
    ...
    if (a->f) {
        flag(0b000000, cpu_regs[a->a], orig_b, cpu_regs[a->c]);
    }
    return true;
}
...
static bool trans_ADD_U6(DisasContext *dc, arg_ADD_U6 *a)
{
    ...
    if (a->f) {
        flag(0b000000, cpu_regs[a->a], orig_b, tcg_constant_i32(a->u));
    }
    return true;
}
...
static bool trans_ADD_S12(DisasContext *dc, arg_ADD_S12 *a)
{
    ...
    if (a->f) {
        flag(0b000000, cpu_regs[a->b], orig_b, tcg_constant_i32(a->s));
    }
    return true;
}
...
static bool trans_ADD_CC_F_U6(DisasContext *dc, arg_ADD_CC_F_U6 *a)
{
    ...
    if (a->f) {
        ...
        tcg_gen_shri_i32(new_n, new_val, 31);
        tcg_gen_setcond_i32(TCG_COND_LTU, new_c, new_val, cpu_regs[a->b]);
        new_v = cpu_vflag_add(cpu_regs[a->b], new_val, tcg_constant_i32(a->u));
        tcg_gen_movcond_i32(TCG_COND_EQ, cpu_zf, cond, tcg_constant_i32(1), new_z, cpu_zf);
        tcg_gen_movcond_i32(TCG_COND_EQ, cpu_nf, cond, tcg_constant_i32(1), new_n, cpu_nf);
        tcg_gen_movcond_i32(TCG_COND_EQ, cpu_cf, cond, tcg_constant_i32(1), new_c, cpu_cf);
        tcg_gen_movcond_i32(TCG_COND_EQ, cpu_vf, cond, tcg_constant_i32(1), new_v, cpu_vf);
...
{   
    ...
    if (a->f) {
        flag(0b000000, cpu_regs[a->a], orig_b, shift_c);
    }
    return true;
}
...
static bool trans_ADD1_U6(DisasContext *dc, arg_ADD1_U6 *a)
{
    ...
    if (a->f) {
        flag(0b000000, cpu_regs[a->a], orig_b, shift_u);
    }
    return true;
}
...
static bool trans_ADD1_S12(DisasContext *dc, arg_ADD1_S12 *a)
{
    ...
    if (a->f) {
        flag(0b000000, cpu_regs[a->b], orig_b, shift_s);
    }
    return true;
}
...
static bool trans_MPY(DisasContext *dc, arg_MPY *a)
{
    ...
    if (a->f) {
        flag(0b011010, tcg_constant_i32(0), lo, hi);
    }
    return true;
}
...
static bool trans_SUB(DisasContext *dc, arg_SUB *a)
{
    ...
    if (a->f) {
        flag(0b000010, cpu_regs[a->a], orig_b, cpu_regs[a->c]);
    }
    return true;
}
...
static bool trans_SUB_u6(DisasContext *dc, arg_SUB_u6 *a)
{
    ...
    if (a->f) {
        flag(0b000010, cpu_regs[a->a], orig_b, tcg_constant_i32(a->u));
    }
    return true;
}
...
static bool trans_SUB_s12(DisasContext *dc, arg_SUB_s12 *a)
{
    ...
    if (a->f) {
        flag(0b000010, cpu_regs[a->b], orig_b, tcg_constant_i32(a->s));
    }
    return true;
}
...
{   
    ...
    if (a->f) {
        flag(0b000010, cpu_regs[a->a], orig_b, shift_c);
    }
    return true;
}
...
static bool trans_SUB1_U6(DisasContext *dc, arg_SUB1_U6 *a)
{
    ...
    if (a->f) {
        flag(0b000010, cpu_regs[a->a], orig_b, shift_u);
    }
    return true;
}
...
static bool trans_SUB1_S12(DisasContext *dc, arg_SUB1_S12 *a)
{
    ...
    if (a->f) {
        flag(0b000010, cpu_regs[a->b], orig_b, shift_s);
    }
    return true;
}
...
static bool trans_ASL(DisasContext *dc, arg_ASL *a)
{
    ...
    if (a->f) {
        flag(0b100000, tcg_constant_i32(0), cpu_regs[a->b], orig_c);
    }
    return true;
}
...
static bool trans_LSR(DisasContext *dc, arg_LSR *a)
{
    ...
    if (a->f) {
        flag(0b100001, tcg_constant_i32(0), cpu_regs[a->b], orig_c);
    }
    return true;
}
...
static bool trans_LSR_U6(DisasContext *dc, arg_LSR_U6 *a)
{
    ...
    if (a->f) {
        flag(0b100001, tcg_constant_i32(0), cpu_regs[a->b], orig_u);
    }
    return true;
}
...
static bool trans_ASR(DisasContext *dc, arg_ASR *a)
{
    ...
    if (a->f) {
        flag(0b111000, tcg_constant_i32(0), cpu_regs[a->b], orig_c);
    }
    return true;
}
...
static bool trans_ASR_U6(DisasContext *dc, arg_ASR_U6 *a)
{
    ...
    if (a->f) {
        flag(0b111000, tcg_constant_i32(0), cpu_regs[a->b], orig_u);
    } 
    return true;
}
...
static bool trans_CMP(DisasContext *dc, arg_CMP *a)
{
    ...
    tcg_gen_mov_i32(cpu_vf, cpu_vflag_sub(cpu_regs[a->b], tmp, cpu_regs[a->c]));
    return true;
}
...
static bool trans_CMP_U6(DisasContext *dc, arg_CMP_U6 *a)
{
    ...
    tcg_gen_mov_i32(cpu_vf, cpu_vflag_sub(cpu_regs[a->b], tmp, tcg_constant_i32(a->u)));
    return true;
}
...
static bool trans_CMP_S12(DisasContext *dc, arg_CMP_S12 *a)
{
    ...
    tcg_gen_mov_i32(cpu_vf, cpu_vflag_sub(cpu_regs[a->b], tmp, tcg_constant_i32(a->s)));
    return true;
}
...
static bool trans_ADC_S12(DisasContext *dc, arg_ADC_S12 *a)
{
    ...
    if (a->f) {
        ...
        tcg_gen_shri_i32(cpu_nf, cpu_regs[a->b], 31);
        tcg_gen_setcondi_i32(TCG_COND_NE, cpu_cf, carry_out, 0);
        TCGv_i32 vflag = cpu_vflag_add(orig_b, cpu_regs[a->b], tcg_constant_i32(a->s));
        tcg_gen_mov_i32(cpu_vf, vflag);
    }
    return true;
}
...
static bool trans_MAX(DisasContext *dc, arg_MAX *a)
{
    ...
    if (a->f) {
        ...
        TCGv_i32 vflag = cpu_vflag_sub(cpu_regs[a->b], alu, cpu_regs[a->c]);
        tcg_gen_mov_i32(cpu_vf, vflag);
    }
    return true;
}
...
static bool trans_MAX_U6(DisasContext *dc, arg_MAX_U6 *a)
{
    ...
    if (a->f) {
        ...
        TCGv_i32 vflag = cpu_vflag_sub(cpu_regs[a->b], alu, tcg_constant_i32(a->u));
        tcg_gen_mov_i32(cpu_vf, vflag);
    }
    return true;
}
...
static bool trans_MAX_S12(DisasContext *dc, arg_MAX_S12 *a)
{
    ...
    if (a->f) {
        ...
        TCGv_i32 vflag = cpu_vflag_sub(orig_b, alu, tcg_constant_i32(a->s));
        tcg_gen_mov_i32(cpu_vf, vflag);
    }
    return true;
}
...
static bool trans_MAX_CC(DisasContext *dc, arg_MAX_CC *a)
{
    ...
    if (a->f) {
        ...
        TCGv_i32 vflag = cpu_vflag_sub(orig_b, alu, cpu_regs[a->c]);
        tcg_gen_mov_i32(cpu_vf, vflag);
    }
    return true;
}
...
static bool trans_RCMP(DisasContext *dc, arg_rcmp *a)
{
    ...
    tcg_gen_mov_i32(cpu_vf, cpu_vflag_sub(cpu_regs[a->c], tmp, cpu_regs[a->b]));
    return true;
}
...
static bool trans_RCMP_U6(DisasContext *dc, arg_rcmp_u6 *a)
{
    ...
    tcg_gen_mov_i32(cpu_vf, cpu_vflag_sub(tcg_constant_i32(a->u), tmp, cpu_regs[a->b]));
    return true;
}
...
static bool trans_RCMP_S12(DisasContext *dc, arg_rcmp_s12 *a)
{
    ...
    tcg_gen_mov_i32(cpu_vf, cpu_vflag_sub(tcg_constant_i32(a->s), tmp, cpu_regs[a->b]));
    return true;
}
...
static bool trans_SBC_CC(DisasContext *dc, arg_SBC_CC *a)
{
    ...
    if (a->f) {
        ...
        tcg_gen_shri_i32(cpu_nf, cpu_regs[a->b], 31);
        tcg_gen_setcondi_i32(TCG_COND_NE, cpu_cf, carry_out, 0);
        TCGv_i32 vflag = cpu_vflag_sub(orig_b, cpu_regs[a->b], cpu_regs[a->c]);
        tcg_gen_mov_i32(cpu_vf, vflag);
    }
    return true;
}
...
static bool trans_SBC_CC_U6(DisasContext *dc, arg_SBC_CC_U6 *a)
{
    ...
    if (a->f) {
        ...
        tcg_gen_shri_i32(cpu_nf, cpu_regs[a->b], 31);
        tcg_gen_setcondi_i32(TCG_COND_NE, cpu_cf, carry_out, 0);
        TCGv_i32 vflag = cpu_vflag_sub(orig_b, cpu_regs[a->b], tcg_constant_i32(a->u));
        tcg_gen_mov_i32(cpu_vf, vflag);
    }
    return true;
}
...
static bool trans_RSUB(DisasContext *dc, arg_RSUB *a)
{
    ...
    if (a->f) {
        flag(0b000010, cpu_regs[a->a], orig_c, orig_b);
    }
    return true;
}
...
static bool trans_RSUB_U6(DisasContext *dc, arg_RSUB_U6 *a)
{
    ...
    if (a->f) {
        flag(0b000010, cpu_regs[a->a], tcg_constant_i32(a->u), orig_b);
    }
    return true;
}
...
static bool trans_RSUB_S12(DisasContext *dc, arg_RSUB_S12 *a)
{
    ...
    if (a->f) {
        flag(0b000010, cpu_regs[a->b], tcg_constant_i32(a->s), orig_b);
    }
    return true;
}
...
static bool trans_RSUB_CC(DisasContext *dc, arg_RSUB_CC *a)
{
    ...
    if (a->f) {
        flag(0b000010, cpu_regs[a->b], orig_c, orig_b);
    }
    return true;
}
...
static bool trans_RSUB_CC_U6(DisasContext *dc, arg_RSUB_CC_U6 *a)
{
    ...
    if (a->f) {
        flag(0b000010, cpu_regs[a->b], tcg_constant_i32(a->u), orig_b);
    }
    return true;
}
